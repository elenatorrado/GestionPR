...
public static final String DEST="Consulta Empleado.pdf";

public ExportarEmpleado(String dest)
{
		...
		try {
			...
			//Array para guardar lo que devuelve la consulta
				String[] registro= exportarpdf.ConsultaEmpleado().split("\n");
			//Añadimos la cabecera
				exportarpdf.process(tabla,"id - Nombre - Apellidos - Puesto",fuenteNegrita, true);
